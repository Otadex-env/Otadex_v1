  ...
  static final GoRouter router = GoRouter(
    ...
    routes: [
      ...
      GoRoute(
        ...
        // Activation de licence par clé. Atteignable dès que l'un des deux
        // flags l'autorise :
        //   • kEnableLicenseEntry : champ de saisie seul (conforme Play Store)
        //   • kEnablePaidPlans    : parcours d'achat complet (Chariow)
        // Si les deux sont false, tout accès (deep link, navigation manuelle)
        // est redirigé vers l'écran informatif des plans.
        redirect: (context, state) =>
            (kEnablePaidPlans || kEnableLicenseEntry) ? null : '/subscription',
...
Future<String> getInitialRoute() async {
  ...
  return isLoggedIn ? AppRouter.home : AppRouter.login;
}

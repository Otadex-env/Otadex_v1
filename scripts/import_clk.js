...
const CLK_BASE = "https://raw.githubusercontent.com/Otadex-env/otadex-assets/main/Animé%20pictures/Classroom%20of%20Elite";
...
const characters = [
  // ── #1 Kiyotaka Ayanokoji ──
  {
    ...
    images: clkImages("Kiyotaka%20Ayanokoji", "clk_ayan", 13),
    imagePath: `${CLK_BASE}/Kiyotaka%20Ayanokoji/clk_ayan1.jpeg`,
    likesCount: 0,
    collectCount: 0,
    isTrending: true,
    isNew: false,
  ...
  // ── #2 Suzune Horikita ──
  {
    ...
    images: clkImages("Suzune%20Horikita", "clk_hori", 6),
    imagePath: `${CLK_BASE}/Suzune%20Horikita/clk_hori1.jpeg`,
    likesCount: 0,
    collectCount: 0,
    isTrending: true,
    isNew: false,
  ...
  // ── #3 Kei Karuizawa ──
  {
    ...
    images: clkImages("Kei%20Karuizawa", "clk_karu", 4),
    imagePath: `${CLK_BASE}/Kei%20Karuizawa/clk_karu1.jpeg`,
    likesCount: 0,
    collectCount: 0,
    isTrending: true,
    isNew: false,
  ...
  // ── #4 Honami Ichinose ──
  {
    ...
    images: clkImages("honami%20ichinose", "clk_ichi", 6),
    imagePath: `${CLK_BASE}/honami%20ichinose/clk_ichi1.jpeg`,
    likesCount: 0,
    collectCount: 0,
    isTrending: false,
    isNew: false,
  ...
  // ── #5 Arisu Sakayanagi ──
  {
    ...
    images: clkImages("Arisu%20Sakayanagi%20", "clk_saka", 9),
    imagePath: `${CLK_BASE}/Arisu%20Sakayanagi%20/clk_saka1.jpeg`,
    likesCount: 0,
    collectCount: 0,
    isTrending: false,
    isNew: false,
  ...
  // ── #6 Kakeru Ryuen ──
  {
    ...
    images: clkImages("kakeru%20ryuen", "clk_ryue", 9),
    imagePath: `${CLK_BASE}/kakeru%20ryuen/clk_ryue1.jpeg`,
    likesCount: 0,
    collectCount: 0,
    isTrending: false,
    isNew: false,
  ...
  // ── #8 Manabu Horikita ──
  {
    ...
    images: clkImages("Manabu%20Horikita", "clk_mana", 6),
    imagePath: `${CLK_BASE}/Manabu%20Horikita/clk_mana1.jpeg`,
    likesCount: 0,
    collectCount: 0,
    isTrending: false,
    isNew: false,
  ...
  // ── #10 Yosuke Hirata ──
  {
    ...
    images: clkImages("yosuke%20hirata", "clk_hira", 5),
    imagePath: `${CLK_BASE}/yosuke%20hirata/clk_hira1.jpeg`,
    likesCount: 0,
    collectCount: 0,
    isTrending: false,
    isNew: false,
  ...
  // ── #14 Ken Sudo ──
  {
    ...
    images: clkImages("ken%20sudo", "clk_sudo", 5),
    imagePath: `${CLK_BASE}/ken%20sudo/clk_sudo1.jpeg`,
    likesCount: 0,
    collectCount: 0,
    isTrending: false,
    isNew: false,
